...
<template>
  <a-modal
    ...
    @cancel="onCancel"
  >
    <template #title>Capybara TapTap & Score Big!</template>
    <div class="content">
      <ol>
        <li>Play, invite friends, and earn coins.</li>
        <li>Don’t forget to mint your Gamerboom Seasonal Passcard SBT for extra rewards.</li>
        <li>Start now and claim your share of a $1 million airdrop from Bitlayer!</li>
      </ol>
    </div>
    <div class="actions">
