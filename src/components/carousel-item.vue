...
<template>
  <div class="carousel-item">
    ...
    >
      ...
      <!-- 默认的 -->
      <img v-else src="@/assets/images/nft.png" />
    </div>
    <div class="right">
      ...
      <div v-else class="button-wrapper">
        <a-button class="button-mint" shape="round" ghost @click="handleGuide">
          <span>USER GUIDE</span>
        </a-button>
        <a-button class="button-mint" shape="round" ghost @click="donwload">
...
.carousel-item {
  ...
  .left {
    ...
    height: clamp(320px, 58.33vw, 580px);
    border-radius: 32px;
    border: 2px solid rgba(39, 43, 64, 0.36);
    flex-shrink: 0;
    padding: 0 20px;
