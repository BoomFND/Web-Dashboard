...
const menuItems = ref([
  {
    label: 'Meta Mask',
    value: 'meta',
    src: 'https://uploads-ssl.webflow.com/654b15dc0a3b3343410f03b8/65ab46e7d6e8611d02aac15e_metamask.png'
  },
  {
    label: 'OKX Wallet',
    value: 'okx',
    src: 'https://uploads-ssl.webflow.com/654b15dc0a3b3343410f03b8/65abd43dcf24d57ccac95282_okx.png'
  },
  {
    label: 'math Wallet',
    value: 'math',
    src: 'https://uploads-ssl.webflow.com/654b15dc0a3b3343410f03b8/65abd43dbe92963c01d1a0c0_math.jpeg'
  }
])
...
// 点击dropdown选项
const connectWalletClick = async (item: any) => {
  showWallet.value = false
  connectWallet(item.value)
}
</script>
  ...
  >
    <div class="drawer__wrapper">
      ...
      <div class="drawer__footer">
        ...
        <a-popover v-model:open="showWallet" v-else title="" trigger="click" color="#191a27">
          <template #content>
            <div class="cell-list">
              <div
                class="cell"
    ...
    <modal-register v-model="openLoginModal"></modal-register>
  </a-drawer>
</template>
