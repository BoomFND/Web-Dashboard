...
const handleTelegram = async () => {
  const { tgVerified } = userStore.account
  if (tgVerified) return
        ...
        <div class="actions">
          ...
          >
            <div class="text-wrapper">
              <SvgIcon name="quest-twitter" /> <span>Connect Twitter First</span>
            </div>
          ...
          >
            <div class="text-wrapper">
              <SvgIcon name="uid-telegram" /> <span>Connect Telegram First</span>
            </div>
